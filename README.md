...
Sou um **Desenvolvedor FullStack** apaixonado por criar sistemas web modernos, escaláveis e bem estruturados.

Trabalho principalmente com **Node.js, TypeScript, React, bancos de dados, cloud e arquitetura de aplicações**.

Gosto de construir produtos digitais que saem do papel e resolvem problemas reais.
...
- APIs robustas com Node.js e TypeScript
- Arquitetura de sistemas SaaS e multi-tenant
- Cloud, DevOps e automações
- Produtos digitais e soluções de alto impacto
...
- 💻 FullStack Developer
- ⚙️ Foco em backend, frontend e arquitetura
- ☁️ Experiência com Cloud e deploy de aplicações
- 🧩 Gosto de resolver problemas complexos
- 🛠️ Sempre buscando melhorar código, produto e processo
...
<table>
  <tr>
    <td width="33%" align="center">
      <h3>🚀 SaaS</h3>
      <p>Sistemas web, plataformas multi-tenant e produtos digitais escaláveis.</p>
    </td>
    <td width="33%" align="center">
      <h3>⚙️ APIs</h3>
      <p>Backends robustos, integrações, autenticação e arquitetura limpa.</p>
    </td>
    <td width="33%" align="center">
      <h3>☁️ Cloud</h3>
...
<picture>
  <source 
    ...
    srcset="https://raw.githubusercontent.com/matheus-cintra/matheus-cintra/output/github-snake-dark.svg" 
  />
  <source 
    media="(prefers-color-scheme: light)" 
    srcset="https://raw.githubusercontent.com/matheus-cintra/matheus-cintra/output/github-snake.svg" 
  />
  <img 
    alt="github contribution snake" 
    src="https://raw.githubusercontent.com/matheus-cintra/matheus-cintra/output/github-snake.svg" 
  />
</picture>
